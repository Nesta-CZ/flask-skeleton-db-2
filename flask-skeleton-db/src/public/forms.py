...
from ..data.models import User, loguzivatele
...
class LogUserForm(Form):
    jmeno = TextField('Zadej jmeno', validators=[
    ...
    prijmeni = TextField('Zadej jmeno', validators=[
        Predicate(safe_characters, message="Please use only letters (a-z) and numbers"),
        Length(min=6, max=30, message="Please use between 6 and 30 characters"),
        InputRequired(message="You can't leave this empty")
    ])
...
class LogUserForm2(Form):
    Tomas = TextField('Zadej jmeno', validators=[
        Predicate(safe_characters, message="Please use only letters (a-z) and numbers"),
        Length(min=6, max=30, message="Please use between 6 and 30 characters"),
        InputRequired(message="You can't leave this empty")
    ])

    Michalovsky = TextField('Zadej jmeno', validators=[
        Predicate(safe_characters, message="Please use only letters (a-z) and numbers"),
        Length(min=6, max=30, message="Please use between 6 and 30 characters"),
        InputRequired(message="You can't leave this empty")
    ])

    sloupec3 = BooleanField('Nic')