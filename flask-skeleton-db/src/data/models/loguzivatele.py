...
class LogUser2(CRUDModel):
    ...
    @staticmethod
    def find_by_sloupec1(sloupec3):
        return db.session.query(LogUser2).filter_by(sloupec3 = sloupec3).all()
